...
namespace PolyPerfect
{
    ...
    public class Animals_WanderScriptEditor : Common_WanderScriptEditor 
    {
        ...
        {
            Animal_WanderScript myWanderScript = (Animal_WanderScript)target;
            ...
            SerializedProperty feastStates = serializedObject.FindProperty("feastStates");
            ...
            if (AnimationStates)
            {
                ...
                GUILayout.BeginHorizontal();
                //GUILayout.Label(feastingTexture);
                GUILayout.EndHorizontal();

                EditorGUILayout.PropertyField(feastStates, true);
